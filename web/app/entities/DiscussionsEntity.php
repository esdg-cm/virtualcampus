...
class DiscussionsEntity
{
    private $_api;

    function __construct($discussion = null, $api = null)
    {
        if(!empty($discussion)) {
    ...
    {
        return scl_translate_date(scl_date($this->date_discussion), 'fr');
    }
    public function getContent() {
        return ucfirst($this->contenue);
    }
