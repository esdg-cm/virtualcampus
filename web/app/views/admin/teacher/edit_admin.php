                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="maxl">
                                    ...
                                    <label class="radio inline offset-1">
                                        <input type="radio" name="is_member_de" <?php if($users->is_member_de == "1"): ?> checked <?php endif; ?>  value="oui">
                                        <span> oui </span>
                                    </label>&nbsp
                                    <label class="radio inline">
                                        <input type="radio" name="is_member_de" <?php if($users->is_member_de == "0"):?> checked <?php endif; ?> value="non">
                                        <span> non </span>
                                    </label>
