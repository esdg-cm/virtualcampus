                    ...
                    <div class="row register-form">
                        <div class="col-md-6" style="border-right: 1px solid lightblue;">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control col-md-10" placeholder="nom l'étudiant" name="nom" value="<?= $users->nom ?>"/>
                                <label class="col-md-1"><span style="color:red">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control col-md-10"  placeholder="prenom l'étudiant" name="prenom" value="<?= $users->prenom ?>"/>
                                <label class="col-md-1"><span style="color:red">*</span></label>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                <input type="checkbox" class="custom-control-input" id="customSwitch3" name="reset" value="1">
                                <label class="custom-control-label" for="customSwitch3">L'utilisateur a-t-il oublié le mot de passe reinitialiser</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                        	<div class="col-md-10">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control col-md-10" name="matricule" placeholder="Matricule de l'étudiant"   value="<?= $users->matricule ?>"/>
                                <label class="col-md-1"><span style="color:red">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="date" name="date_naiss" class="form-control col-md-10" placeholder="date naissance de l'étudiant"   value="<?= $users->date_naiss ?>"/>
                                <label class="col-md-1"><span style="color:red">*</span></label>
                            </div>
                            <div class="form-group">
                                <input type="text" name="lieu_naiss" class="form-control col-md-10" placeholder="lieu de naissance de l'étudiant"   value="<?= $users->lieu_naiss ?>"/>
                                <label class="col-md-1"><span style="color:red">*</span></label>
                            </div>
                            <div class="form-group">
