...
<div class="row page-title-header">
    <div class="col-12 py-0 m-0">
        <div class="page-header d-flex py-0 my-0 justify-content-between">
            <h4 class="page-title"> <i class="fa fa-chalkboard-teacher"></i> Sessions normales</h4>
            <nav aria-label="breadcrumb" class="d-none d-md-block m-0">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= site_url('students'); ?>">Accueil</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sessions normales</li>
              </ol>
            </nav>
        </div>
    </div>
...
<div class="card">
    <div class="card-header pb-0 border-0">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a role="tab" data-toggle="tab" class="nav-link active" href="<?= site_url('students/exams/ajax_sn/results'); ?>"
                    data-dan-target="list-sn"
            ...
            <li class="nav-item">
                <a role="tab" data-toggle="tab" class="nav-link" href="<?= site_url('students/exams/ajax_sn/programmated'); ?>"
                    data-dan-target="list-sn"
                    data-dan-animation="facebook"
                      >
    ...
    <div class="card-body px-1 px-md-4">
        <div class="tab-content mt-3">
            <div class="w-100" role="tabpanel" data-dan-box="list-sn"></div>
        </div>
    </div>
</div>
